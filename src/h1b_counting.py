...
data_list = [[job_title, employer_state]]
for line in input_file: # do I need i
    ...
    if currentline[status_ind] == 'CERTIFIED': 
        currentline = [currentline[c_ind], currentline[s_ind]]
